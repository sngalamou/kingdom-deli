...
import { listeners, actor, emptyActor, isEmptyActor } from "./context.js";
...
function useOptimisticActorReady() {
  const $ = c(2), actor2 = useOptimisticActor();
  let t0;
  return $[0] !== actor2 ? (t0 = isEmptyActor(actor2), $[0] = actor2, $[1] = t0) : t0 = $[1], !t0;
}

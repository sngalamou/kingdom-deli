...
import { useEffect, createContext, useContext, useState, memo, useRef, startTransition, useId, Fragment as Fragment$1, isValidElement, useSyncExternalStore, useDeferredValue, useEffectEvent, useReducer, lazy, Suspense } from "react";
...
import { useDocuments, getArrayItemKeyAndParentPath, get, getArrayMovePatches, getArrayInsertPatches, getArrayDuplicatePatches, getArrayRemovePatches, useOptimisticActorReady, useOptimisticActor } from "./mutations.js";
import { v4, SharedStateContext, createOverlayController, sanityNodesExistInSameArray } from "./SharedStateContext.js";
import { at, remove, insert } from "@sanity/mutate";
import { getNodeIcon, InsertMenu, PopoverPortal, useTelemetry, PopoverBackground, PointerEvents, TelemetryContext, events } from "./PointerEvents.js";
...
const History = (props) => {
  ...
  $[0] !== comlink2 || $[1] !== history ? (t0 = () => comlink2?.on("presentation/navigate", (data) => {
    history?.update(data);
  }), t1 = [comlink2, history], $[0] = comlink2, $[1] = history, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), useEffect(t0, t1);
  let t2, t3;
  ...
  }, t3 = [comlink2, history], $[4] = comlink2, $[5] = history, $[6] = t2, $[7] = t3) : (t2 = $[6], t3 = $[7]), useEffect(t2, t3), null;
}, comlinkListeners = /* @__PURE__ */ new Set();
let comlink = null, comlinkProjectId = null, comlinkDataset = null, comlinkPerspective = null;
...
const Meta = (props) => {
  ...
  }, t1 = [comlink2], $[0] = comlink2, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1), null;
};
    ...
    const handler = (e) => {
      ...
      if (reference) {
        ...
        arrayPath && referenceItemKey && referenceItemKey !== targetKey && doc.patch(async (t22) => {
          ...
          } = t22, snapshot = await getSnapshot2(), elementValue = get(snapshot, target.path);
...
function getArrayRemoveAction(node, doc) {
  ...
  return () => doc.patch(async ({
    getSnapshot: getSnapshot2
  }) => getArrayRemovePatches(node, await getSnapshot2()));
}
...
function getDuplicateAction(node, doc) {
  ...
  return () => doc.patch(async ({
    getSnapshot: getSnapshot2
  }) => getArrayDuplicatePatches(node, await getSnapshot2()));
}
...
const InsertMenuWrapper = (props) => {
  ...
  let t0;
  $[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t0 = ["left-start", "right", "left", "right-end", "left-end", "bottom", "top"], $[0] = t0) : t0 = $[0];
  let t1;
  $[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = [4, 4, 4, 4], $[1] = t1) : t1 = $[1];
  let t2;
...
function ContextMenuItem(props) {
  ...
  if (node.type === "divider") {
    let t1;
    return $[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsx(MenuDivider, {}), $[4] = t1) : t1 = $[4], t1;
  }
  if (node.type === "action") {
...
const ContextMenu = (props) => {
  ...
  const {
    field,
    parent
  } = t1, title = field?.title || field?.name || "Unknown type", [items, setItems] = useState(void 0);
  let t2, t3;
  ...
  }, t3 = [field, node, parent, getDocument], $[3] = field, $[4] = getDocument, $[5] = node, $[6] = parent, $[7] = t2, $[8] = t3) : (t2 = $[7], t3 = $[8]), useEffect(t2, t3);
  let t4;
  $[9] !== x || $[10] !== y ? (t4 = {
  ...
  let t5;
  $[12] !== field ? (t5 = getNodeIcon(field), $[12] = field, $[13] = t5) : t5 = $[13];
  const icon = t5;
  let t6;
  ...
  let t7;
  $[15] !== icon || $[16] !== items ? (t7 = /* @__PURE__ */ jsx(Box, { flex: "none", children: items ? /* @__PURE__ */ jsx(Text, { size: 1, children: icon }) : /* @__PURE__ */ jsx(Spinner, { size: 1 }) }), $[15] = icon, $[16] = items, $[17] = t7) : t7 = $[17];
  const t8 = items ? title : "Loading...";
  let t9;
  $[18] !== t8 ? (t9 = /* @__PURE__ */ jsx(Stack, { flex: 1, space: 2, children: /* @__PURE__ */ jsx(Text, { size: 1, weight: "semibold", children: t8 }) }), $[18] = t8, $[19] = t9) : t9 = $[19];
  let t10;
  $[20] !== t7 || $[21] !== t9 ? (t10 = /* @__PURE__ */ jsxs(Flex, { gap: 2, padding: 2, children: [
    t7,
    t9
  ] }), $[20] = t7, $[21] = t9, $[22] = t10) : t10 = $[22];
  let t11;
  $[23] !== boundaryElement || $[24] !== items || $[25] !== onDismiss ? (t11 = items && /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  let t12;
  $[27] !== t10 || $[28] !== t11 ? (t12 = /* @__PURE__ */ jsxs(Menu, { style: t6, children: [
    t10,
    t11
  ...
  let t15;
  $[33] !== t13 || $[34] !== t14 ? (t15 = /* @__PURE__ */ jsx("div", { style: t14 }, t13), $[33] = t13, $[34] = t14, $[35] = t15) : t15 = $[35];
  let t16;
  $[36] !== contextMenuReferenceElement || $[37] !== t12 || $[38] !== t15 ? (t16 = /* @__PURE__ */ jsx(Popover, { __unstable_margins: POPOVER_MARGINS, arrow: !1, open: !0, placement: "right-start", referenceElement: contextMenuReferenceElement, content: t12, children: t15 }), $[36] = contextMenuReferenceElement, $[37] = t12, $[38] = t15, $[39] = t16) : t16 = $[39];
  let t17;
  return $[40] !== onDismiss || $[41] !== t16 ? (t17 = /* @__PURE__ */ jsx(PopoverPortal, { setBoundaryElement, onDismiss, children: t16 }), $[40] = onDismiss, $[41] = t16, $[42] = t17) : t17 = $[42], t17;
};
...
const ElementOverlayInner = (props) => {
  ...
  let t7;
  $[25] !== schemaType ? (t7 = schemaType?.icon ? /* @__PURE__ */ jsx("div", { dangerouslySetInnerHTML: {
    __html: schemaType.icon
  } }) : /* @__PURE__ */ jsx(DocumentIcon, {}), $[25] = schemaType, $[26] = t7) : t7 = $[26];
  const icon = t7, menuId = useId();
  let t8;
  ...
  let t10;
  $[31] !== href || $[32] !== inFrame || $[33] !== showActions ? (t10 = showActions ? /* @__PURE__ */ jsx(Actions, { gap: 1, paddingY: 1, children: /* @__PURE__ */ jsx(Link, { inFrame, href }) }) : null, $[31] = href, $[32] = inFrame, $[33] = showActions, $[34] = t10) : t10 = $[34];
  let t11;
  $[35] !== comlink2 || $[36] !== draggable || $[37] !== handleLabelClick || $[38] !== icon || $[39] !== menuId || $[40] !== nodePluginCollections || $[41] !== onActivateExclusivePlugin || $[42] !== onMenuOpenChange || $[43] !== showMenu || $[44] !== title ? (t11 = (title || showMenu) && /* @__PURE__ */ jsx(Tab, { gap: 1, paddingY: 1, onClick: handleLabelClick, children: /* @__PURE__ */ jsxs(Labels, { gap: 2, padding: 2, children: [
    ...
    showMenu && /* @__PURE__ */ jsx(Box, { paddingLeft: 2, onClick: _temp3$3, children: /* @__PURE__ */ jsx(MenuWrapper, { children: /* @__PURE__ */ jsx(MenuButton, { id: menuId, popover: {
      animate: !0,
  ...
  let t13;
  $[48] !== t12 ? (t13 = /* @__PURE__ */ jsx(HUD, { children: t12 }), $[48] = t12, $[49] = t13) : t13 = $[49];
  let t14;
  $[50] !== t10 || $[51] !== t11 || $[52] !== t13 ? (t14 = /* @__PURE__ */ jsxs(PointerEvents, { children: [
    t10,
    t11,
    t13
  ...
  let t16;
  return $[57] !== t14 || $[58] !== t15 ? (t16 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t14,
    t15
  ...
  const $ = c(39), {
    ...
    inFrame
  } = props, ref = useRef(null), scrolledIntoViewRef = useRef(!1), t0 = `${rect.w}px`, t1 = `${rect.h}px`, t2 = `translate(${rect.x}px, ${rect.y}px)`;
  let t3;
  $[0] !== t0 || $[1] !== t1 || $[2] !== t2 ? (t3 = {
    width: t0,
    height: t1,
  ...
  }, t5 = [focused, wasMaybeCollapsed, enableScrollIntoView], $[4] = enableScrollIntoView, $[5] = focused, $[6] = wasMaybeCollapsed, $[7] = t4, $[8] = t5) : (t4 = $[7], t5 = $[8]), useEffect(t4, t5);
  ...
  let t7;
  $[11] !== hovered || $[12] !== isNearTop ? (t7 = [hovered, isNearTop], $[11] = hovered, $[12] = isNearTop, $[13] = t7) : t7 = $[13], useEffect(t6, t7);
  ...
  const onActivateExclusivePlugin = t9, handleExclusivePluginClick = _temp5$1, ExclusivePluginComponent = activeExclusivePlugin?.plugin.component, [menuOpen, setMenuOpen] = useState(!1);
  let t10;
  $[16] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t10 = () => {
    startTransition(() => setMenuOpen(!1));
  }, $[16] = t10) : t10 = $[16];
  let t11;
  $[17] !== hovered ? (t11 = [hovered], $[17] = hovered, $[18] = t11) : t11 = $[18], useEffect(t10, t11);
  let t12;
  $[19] !== ExclusivePluginComponent || $[20] !== menuOpen ? (t12 = menuOpen || ExclusivePluginComponent ? /* @__PURE__ */ jsx(PopoverBackground, { onDismiss: closeExclusivePluginView, blockScroll: menuOpen }) : null, $[19] = ExclusivePluginComponent, $[20] = menuOpen, $[21] = t12) : t12 = $[21];
  const t13 = focused ? "" : void 0, t14 = hovered ? "" : void 0, t15 = isNearTop ? "" : void 0, t16 = draggable ? "" : void 0, t17 = menuOpen ? "" : void 0;
  let t18;
  $[22] !== ExclusivePluginComponent || $[23] !== activeExclusivePlugin || $[24] !== hovered || $[25] !== inFrame || $[26] !== props ? (t18 = ExclusivePluginComponent ? /* @__PURE__ */ jsx(ExclusivePluginContainer, { "data-sanity-overlay-element": !0, onClick: handleExclusivePluginClick, children: /* @__PURE__ */ jsx(ExclusivePluginComponent, { ...activeExclusivePlugin.context, closeExclusiveView: closeExclusivePluginView }) }) : hovered ? /* @__PURE__ */ jsx(ElementOverlayInner, { ...props, inFrame, onActivateExclusivePlugin, onMenuOpenChange: setMenuOpen }) : null, $[22] = ExclusivePluginComponent, $[23] = activeExclusivePlugin, $[24] = hovered, $[25] = inFrame, $[26] = props, $[27] = t18) : t18 = $[27];
  let t19;
  $[28] !== style || $[29] !== t13 || $[30] !== t14 || $[31] !== t15 || $[32] !== t16 || $[33] !== t17 || $[34] !== t18 ? (t19 = /* @__PURE__ */ jsx(Root$3, { "data-focused": t13, "data-hovered": t14, "data-flipped": t15, "data-draggable": t16, "data-menu-open": t17, ref, style, children: t18 }), $[28] = style, $[29] = t13, $[30] = t14, $[31] = t15, $[32] = t16, $[33] = t17, $[34] = t18, $[35] = t19) : t19 = $[35];
  let t20;
  return $[36] !== t12 || $[37] !== t19 ? (t20 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t12,
    t19
...
function useCustomComponents(componentContext, componentResolver) {
  ...
  if ($[0] !== componentContext || $[1] !== componentResolver) {
    bb0: {
      ...
      t0 = (Array.isArray(resolved) ? resolved : [resolved]).map(_temp6$1);
    }
...
const Link = memo(function(props) {
  const $ = c(8), {
    inFrame
  } = props, referer = useSyncExternalStore(_temp7$1, _temp8$1);
  let t0;
  ...
  let t3;
  $[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t3 = /* @__PURE__ */ jsx(ActionOpen, { padding: 2, children: /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: "Open in Studio" }) }), $[3] = t3) : t3 = $[3];
  let t4;
  return $[4] !== href || $[5] !== t1 || $[6] !== t2 ? (t4 = /* @__PURE__ */ jsx(Box, { as: "a", href, target: t1, rel: t2, children: t3 }), $[4] = href, $[5] = t1, $[6] = t2, $[7] = t4) : t4 = $[7], t4;
});
...
`, OverlayMinimapPrompt = () => {
  ...
  let t1;
  return $[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel") ? (t1 = /* @__PURE__ */ jsx(Root$1, { padding: 2, shadow: 2, radius: 2, style: t0, children: /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 2, children: [
...
const PreviewSnapshotsProvider = function(props) {
  ...
  }, t3 = [comlink2, fetchPreviewSnapshots], $[3] = comlink2, $[4] = fetchPreviewSnapshots, $[5] = t2, $[6] = t3) : (t2 = $[5], t3 = $[6]), useEffect(t2, t3);
  let t4, t5;
  $[7] !== comlink2 ? (t4 = () => comlink2?.on("presentation/preview-snapshots", (data) => {
    setPreviewSnapshots(data.snapshots);
  }), t5 = [comlink2], $[7] = comlink2, $[8] = t4, $[9] = t5) : (t4 = $[8], t5 = $[9]), useEffect(t4, t5);
  const context = previewSnapshots;
  let t6;
  return $[10] !== children || $[11] !== context ? (t6 = /* @__PURE__ */ jsx(PreviewSnapshotsContext.Provider, { value: context, children }), $[10] = children, $[11] = context, $[12] = t6) : t6 = $[12], t6;
};
...
const SchemaProvider = function(props) {
  ...
  }, t2 = [comlink2], $[1] = comlink2, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), useEffect(t1, t2);
  let t3;
  ...
  }, t7 = [comlink2, paths], $[7] = comlink2, $[8] = paths, $[9] = t6, $[10] = t7) : (t6 = $[9], t7 = $[10]), useEffect(t6, t7);
  let t8;
  ...
  const context = t10;
  let t11;
  return $[19] !== children || $[20] !== context ? (t11 = /* @__PURE__ */ jsx(SchemaContext.Provider, { value: context, children }), $[19] = children, $[20] = context, $[21] = t11) : t11 = $[21], t11;
};
...
const createStore = (initialState) => {
  ...
  let t0, t1;
  $[0] !== comlink2 ? (t0 = () => comlink2?.on("presentation/shared-state", _temp$6), t1 = [comlink2], $[0] = comlink2, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1);
  let t2, t3;
  $[3] !== comlink2 ? (t2 = () => {
    (async function() {
  ...
  }, t3 = [comlink2], $[3] = comlink2, $[4] = t2, $[5] = t3) : (t2 = $[4], t3 = $[5]), useEffect(t2, t3);
  let t4;
  $[6] !== comlink2 ? (t4 = {
    comlink: comlink2,
    store
  ...
  const value_0 = t4;
  let t5;
  return $[8] !== children || $[9] !== value_0 ? (t5 = /* @__PURE__ */ jsx(SharedStateContext.Provider, { value: value_0, children }), $[8] = children, $[9] = value_0, $[10] = t5) : t5 = $[10], t5;
};
...
function usePerspectiveSync(comlink2, dispatch, onPerspectiveChange) {
  const $ = c(9);
  let t0;
  $[0] !== dispatch || $[1] !== onPerspectiveChange ? (t0 = (data) => {
    dispatch({
      type: "presentation/perspective",
      data
    }), onPerspectiveChange?.(data.perspective);
  }, $[0] = dispatch, $[1] = onPerspectiveChange, $[2] = t0) : t0 = $[2];
  const handlePerspective = useEffectEvent(t0);
  let t1;
  $[3] !== comlink2 || $[4] !== handlePerspective ? (t1 = () => {
    const controller = new AbortController();
    comlink2?.fetch("visual-editing/fetch-perspective", void 0, {
  ...
  }, $[3] = comlink2, $[4] = handlePerspective, $[5] = t1) : t1 = $[5];
  let t2;
  $[6] !== comlink2 || $[7] !== dispatch ? (t2 = [comlink2, dispatch], $[6] = comlink2, $[7] = dispatch, $[8] = t2) : t2 = $[8], useEffect(t1, t2);
}
function _temp$5() {
}
...
function useReportDocuments(comlink2, elements, perspective) {
  ...
  let t0;
  $[0] !== comlink2 ? (t0 = (documents, perspective_0) => {
  ...
  $[2] !== elements || $[3] !== perspective || $[4] !== reportDocuments ? (t1 = () => {
    const nodes = elements.map(_temp$4).filter(_temp2$3), nodeIds = new Set(nodes.map(_temp3$2));
...
const DocumentReporter = (props) => {
  ...
  let t1, t2;
  $[1] !== documentIds ? (t1 = () => {
    startTransition(() => setUniqueIds((prev) => {
...
function Overlays(props) {
  ...
  }, t3 = [comlink2], $[1] = comlink2, $[2] = t2, $[3] = t3) : (t2 = $[2], t3 = $[3]), useEffect(t2, t3), usePerspectiveSync(comlink2, dispatch, onPerspectiveChange), useReportDocuments(comlink2, elements, perspective);
  let t4;
  ...
  $[8] !== overlayEnabled ? (t7 = () => {
    ...
    fadeOutTimeoutRef.current && (clearTimeout(fadeOutTimeoutRef.current), startTransition(() => {
  ...
  const closeContextMenu = t10, optimisticActorReady = useOptimisticActorReady(), componentResolver = optimisticActorReady ? _componentResolver : void 0, [shouldHideActions, setShouldHideActions] = useState(!1);
  ...
  bb0: {
    ...
    $[15] !== comlink2 || $[16] !== componentResolver || $[17] !== dragMinimapTransition || $[18] !== dragShowMinimap || $[19] !== elements || $[20] !== inFrame || $[21] !== isDragging || $[22] !== optimisticActorReady || $[23] !== props.plugins || $[24] !== shouldHideActions || $[25] !== wasMaybeCollapsed ? (t122 = elements.filter(_temp0).map((t132) => {
      const {
        ...
        targets,
        elementType
      } = t132, draggable = !dragDisabled && !!element_0.getAttribute("data-sanity") && optimisticActorReady && elements.some((e_2) => "id" in e_2.sanity && "id" in sanity ? sanityNodesExistInSameArray(e_2.sanity, sanity) && e_2.sanity.path !== sanity.path : !1);
      return /* @__PURE__ */ jsx(ElementOverlay, { comlink: comlink2, componentResolver, plugins: props.plugins, element: element_0, enableScrollIntoView: !isDragging && !dragMinimapTransition && !dragShowMinimap, id, focused, hovered, node: sanity, rect, showActions: !shouldHideActions, draggable, isDragging: isDragging || dragMinimapTransition, wasMaybeCollapsed: focused && wasMaybeCollapsed, targets, elementType, inFrame }, id);
  ...
  let t15;
  $[27] !== documentIds || $[28] !== perspective ? (t15 = /* @__PURE__ */ jsx(DocumentReporter, { documentIds, perspective }), $[27] = documentIds, $[28] = perspective, $[29] = t15) : t15 = $[29];
  let t16;
  $[30] !== comlink2 || $[31] !== inFrame || $[32] !== inPopUp || $[33] !== overlayEnabled || $[34] !== rootElement || $[35] !== updateDragPreviewCustomProps ? (t16 = /* @__PURE__ */ jsx(OverlaysController, { comlink: comlink2, dispatch, inFrame, inPopUp, onDrag: updateDragPreviewCustomProps, overlayEnabled, rootElement }), $[30] = comlink2, $[31] = inFrame, $[32] = inPopUp, $[33] = overlayEnabled, $[34] = rootElement, $[35] = updateDragPreviewCustomProps, $[36] = t16) : t16 = $[36];
  let t17;
  $[37] !== contextMenu ? (t17 = contextMenu && /* @__PURE__ */ jsx(ContextMenu, { ...contextMenu, onDismiss: closeContextMenu }), $[37] = contextMenu, $[38] = t17) : t17 = $[38];
  let t18;
  $[39] !== dragGroupRect || $[40] !== dragInsertPosition || $[41] !== dragMinimapTransition || $[42] !== dragShowMinimapPrompt || $[43] !== isDragging ? (t18 = isDragging && !dragMinimapTransition && /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  let t19;
  $[45] !== dragSkeleton || $[46] !== isDragging ? (t19 = isDragging && dragSkeleton && /* @__PURE__ */ jsx(OverlayDragPreview, { skeleton: dragSkeleton }), $[45] = dragSkeleton, $[46] = isDragging, $[47] = t19) : t19 = $[47];
  let t20;
  $[48] !== elementsToRender || $[49] !== t13 || $[50] !== t14 || $[51] !== t15 || $[52] !== t16 || $[53] !== t17 || $[54] !== t18 || $[55] !== t19 || $[56] !== zIndex ? (t20 = /* @__PURE__ */ jsxs(Root, { "data-fading-out": t13, "data-overlays": t14, ref: setRootElement, $zIndex: zIndex, children: [
    t15,
    t16,
    t17,
    elementsToRender,
  ...
  let t21;
  $[58] !== comlink2 || $[59] !== t20 ? (t21 = /* @__PURE__ */ jsx(SharedStateProvider, { comlink: comlink2, children: t20 }), $[58] = comlink2, $[59] = t20, $[60] = t21) : t21 = $[60];
  let t22;
  $[61] !== comlink2 || $[62] !== t21 ? (t22 = /* @__PURE__ */ jsx(PreviewSnapshotsProvider, { comlink: comlink2, children: t21 }), $[61] = comlink2, $[62] = t21, $[63] = t22) : t22 = $[63];
  let t23;
  $[64] !== comlink2 || $[65] !== elements || $[66] !== t22 ? (t23 = /* @__PURE__ */ jsx(SchemaProvider, { comlink: comlink2, elements, children: t22 }), $[64] = comlink2, $[65] = elements, $[66] = t22, $[67] = t23) : t23 = $[67];
  let t24;
  $[68] !== rootElement || $[69] !== t23 ? (t24 = /* @__PURE__ */ jsx(LayerProvider, { children: /* @__PURE__ */ jsx(PortalProvider, { element: rootElement, children: t23 }) }), $[68] = rootElement, $[69] = t23, $[70] = t24) : t24 = $[70];
  let t25;
  $[71] !== t12 || $[72] !== t24 ? (t25 = /* @__PURE__ */ jsx(ThemeProvider, { scheme: t12, theme: studioTheme, tone: "transparent", children: t24 }), $[71] = t12, $[72] = t24, $[73] = t25) : t25 = $[73];
  let t26;
  return $[74] !== comlink2 || $[75] !== t25 ? (t26 = /* @__PURE__ */ jsx(TelemetryProvider, { comlink: comlink2, children: t25 }), $[74] = comlink2, $[75] = t25, $[76] = t26) : t26 = $[76], t26;
}
function _temp0(e_1) {
...
const Refresh = (props) => {
  ...
  }), t1 = [comlink2, refresh], $[0] = comlink2, $[1] = refresh, $[2] = t0, $[3] = t1) : (t0 = $[2], t1 = $[3]), useEffect(t0, t1), null;
};
function useComlink(t0) {
  ...
  $[0] !== active ? (t1 = () => {
    ...
    return () => {
      unsub(), stop(), startTransition(() => setNode(void 0));
    };
...
function useDatasetMutator(comlink2) {
  ...
  $[0] !== comlink2 ? (t0 = () => {
    if (!comlink2)
      return;
    const listener = createSharedListener(comlink2), datasetMutator = createDatasetMutator(comlink2), mutator = createActor(datasetMutator, {
      input: {
        client: {
          withConfig: _temp$1
        },
  ...
  }, t1 = [comlink2], $[0] = comlink2, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1);
}
function _temp2$1() {
...
const LoaderComlink = lazy(() => import("./LoaderComlink.js")), VisualEditing = (props) => {
  const $ = c(33), {
    components,
    plugins,
    history,
  ...
  $[2] !== portal ? (t3 = () => {
    ...
    return document.documentElement.appendChild(node), startTransition(() => setPortalElement(node)), () => {
      startTransition(() => setPortalElement(null)), document.documentElement.contains(node) && document.documentElement.removeChild(node);
    };
  ...
  const hasQueryListeners2 = useDeferredValue(useSyncExternalStore(subscribeQueryListenerStatus, getQueryListenerStatus, _temp), !1);
  let t5, t6;
  $[5] !== comlinkStatus || $[6] !== inFrame || $[7] !== inPopUp ? (t5 = () => {
    ...
    return _temp3;
  }, t6 = [comlinkStatus, inPopUp, inFrame], $[5] = comlinkStatus, $[6] = inFrame, $[7] = inPopUp, $[8] = t5, $[9] = t6) : (t5 = $[8], t6 = $[9]), useEffect(t5, t6);
  let t7;
  $[10] !== comlink2 || $[11] !== comlinkStatus || $[12] !== components || $[13] !== inFrame || $[14] !== inPopUp || $[15] !== onPerspectiveChange || $[16] !== plugins || $[17] !== zIndex ? (t7 = inFrame !== null && inPopUp !== null && /* @__PURE__ */ jsx(Overlays, { comlink: comlink2, comlinkStatus, componentResolver: components, onPerspectiveChange, plugins, inFrame, inPopUp, zIndex }), $[10] = comlink2, $[11] = comlinkStatus, $[12] = components, $[13] = inFrame, $[14] = inPopUp, $[15] = onPerspectiveChange, $[16] = plugins, $[17] = zIndex, $[18] = t7) : t7 = $[18];
  let t8;
  $[19] !== comlink2 || $[20] !== history || $[21] !== refresh ? (t8 = comlink2 && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(History, { comlink: comlink2, history }),
    /* @__PURE__ */ jsx(Meta, { comlink: comlink2 }),
    refresh && /* @__PURE__ */ jsx(Refresh, { comlink: comlink2, refresh })
  ] }), $[19] = comlink2, $[20] = history, $[21] = refresh, $[22] = t8) : t8 = $[22];
  let t9;
  $[23] !== comlinkStatus || $[24] !== hasQueryListeners2 ? (t9 = comlinkStatus === "connected" && hasQueryListeners2 && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(LoaderComlink, {}) }), $[23] = comlinkStatus, $[24] = hasQueryListeners2, $[25] = t9) : t9 = $[25];
  let t10;
  $[26] !== t7 || $[27] !== t8 || $[28] !== t9 ? (t10 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t7,
    t8,
    t9
  ...
  if (portal === !1 || !portalElement)
    return children;
  let t11;
  return $[30] !== children || $[31] !== portalElement ? (t11 = createPortal(children, portalElement), $[30] = children, $[31] = portalElement, $[32] = t11) : t11 = $[32], t11;
};

...
var tt = { exports: {} }, rt = { exports: {} }, at = {}, Z = {}, Bt;
function Dt() {
  if (Bt) return Z;
  Bt = 1, Z.byteLength = o, Z.toByteArray = I, Z.fromByteArray = O;
  for (var a = [], c = [], l = typeof Uint8Array < "u" ? Uint8Array : Array, p = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", g = 0, d = p.length; g < d; ++g)
    a[g] = p[g], c[p.charCodeAt(g)] = g;
  c[45] = 62, c[95] = 63;
  function f(h) {
    var m = h.length;
    if (m % 4 > 0)
  ...
  function I(h) {
    var m, y = f(h), S = y[0], P = y[1], U = new l(B(h, S, P)), T = 0, q = P > 0 ? S - 4 : S, C;
    for (C = 0; C < q; C += 4)
      m = c[h.charCodeAt(C)] << 18 | c[h.charCodeAt(C + 1)] << 12 | c[h.charCodeAt(C + 2)] << 6 | c[h.charCodeAt(C + 3)], U[T++] = m >> 16 & 255, U[T++] = m >> 8 & 255, U[T++] = m & 255;
    return P === 2 && (m = c[h.charCodeAt(C)] << 2 | c[h.charCodeAt(C + 1)] >> 4, U[T++] = m & 255), P === 1 && (m = c[h.charCodeAt(C)] << 10 | c[h.charCodeAt(C + 1)] << 4 | c[h.charCodeAt(C + 2)] >> 2, U[T++] = m >> 8 & 255, U[T++] = m & 255), U;
  }
  function A(h) {
    return a[h >> 18 & 63] + a[h >> 12 & 63] + a[h >> 6 & 63] + a[h & 63];
  }
  function F(h, m, y) {
    for (var S, P = [], U = m; U < y; U += 3)
      S = (h[U] << 16 & 16711680) + (h[U + 1] << 8 & 65280) + (h[U + 2] & 255), P.push(A(S));
    return P.join("");
  }
  function O(h) {
    for (var m, y = h.length, S = y % 3, P = [], U = 16383, T = 0, q = y - S; T < q; T += U)
      P.push(F(h, T, T + U > q ? q : T + U));
    return S === 1 ? (m = h[y - 1], P.push(
      a[m >> 2] + a[m << 4 & 63] + "=="
    )) : S === 2 && (m = (h[y - 2] << 8) + h[y - 1], P.push(
      a[m >> 10] + a[m >> 4 & 63] + a[m << 2 & 63] + "="
    )), P.join("");
  }
  return Z;
}
...
var Et;
function zt() {
  return Et || (Et = 1, et.read = function(a, c, l, p, g) {
    var d, f, o = g * 8 - p - 1, B = (1 << o) - 1, I = B >> 1, A = -7, F = l ? g - 1 : 0, O = l ? -1 : 1, h = a[c + F];
    for (F += O, d = h & (1 << -A) - 1, h >>= -A, A += o; A > 0; d = d * 256 + a[c + F], F += O, A -= 8)
      ;
    for (f = d & (1 << -A) - 1, d >>= -A, A += p; A > 0; f = f * 256 + a[c + F], F += O, A -= 8)
      ;
    if (d === 0)
      d = 1 - I;
    else {
      if (d === B)
        return f ? NaN : (h ? -1 : 1) * (1 / 0);
      f = f + Math.pow(2, p), d = d - I;
    }
    return (h ? -1 : 1) * f * Math.pow(2, d - p);
  }, et.write = function(a, c, l, p, g, d) {
    var f, o, B, I = d * 8 - g - 1, A = (1 << I) - 1, F = A >> 1, O = g === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = p ? 0 : d - 1, m = p ? 1 : -1, y = c < 0 || c === 0 && 1 / c < 0 ? 1 : 0;
    for (c = Math.abs(c), isNaN(c) || c === 1 / 0 ? (o = isNaN(c) ? 1 : 0, f = A) : (f = Math.floor(Math.log(c) / Math.LN2), c * (B = Math.pow(2, -f)) < 1 && (f--, B *= 2), f + F >= 1 ? c += O / B : c += O * Math.pow(2, 1 - F), c * B >= 2 && (f++, B /= 2), f + F >= A ? (o = 0, f = A) : f + F >= 1 ? (o = (c * B - 1) * Math.pow(2, g), f = f + F) : (o = c * Math.pow(2, F - 1) * Math.pow(2, g), f = 0)); g >= 8; a[l + h] = o & 255, h += m, o /= 256, g -= 8)
      ;
    for (f = f << g | o, I += g; I > 0; a[l + h] = f & 255, h += m, f /= 256, I -= 8)
      ;
    a[l + h - m] |= y * 128;
  }), et;
}
...
function $t() {
  return It || (It = 1, (function(a) {
    const c = Dt(), l = zt(), p = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
    a.Buffer = o, a.SlowBuffer = U, a.INSPECT_MAX_BYTES = 50;
    const g = 2147483647;
    a.kMaxLength = g, o.TYPED_ARRAY_SUPPORT = d(), !o.TYPED_ARRAY_SUPPORT && typeof console < "u" && typeof console.error == "function" && console.error(
    ...
    function A(e, t, r) {
      return I(e), e <= 0 ? f(e) : t !== void 0 ? typeof r == "string" ? f(e).fill(t, r) : f(e).fill(t) : f(e);
    }
    o.alloc = function(e, t, r) {
      return A(e, t, r);
    };
    function F(e) {
      return I(e), f(e < 0 ? 0 : P(e) | 0);
    }
    ...
    function h(e) {
      const t = e.length < 0 ? 0 : P(e.length) | 0, r = f(t);
      for (let n = 0; n < t; n += 1)
        r[n] = e[n] & 255;
      return r;
    }
    ...
    function S(e) {
      if (o.isBuffer(e)) {
        const t = P(e.length) | 0, r = f(t);
        return r.length === 0 || e.copy(r, 0, 0, t), r;
      }
      if (e.length !== void 0)
        return typeof e.length != "number" || st(e.length) ? f(0) : h(e);
    ...
    o.isBuffer = function(t) {
      ...
      if (z(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), z(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(t) || !o.isBuffer(r))
        throw new TypeError(
          'The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array'
        );
      if (t === r) return 0;
      let n = t.length, i = r.length;
      for (let u = 0, s = Math.min(n, i); u < s; ++u)
        if (t[u] !== r[u]) {
          n = t[u], i = r[u];
          break;
        }
      ...
      if (r === void 0)
        for (r = 0, n = 0; n < t.length; ++n)
          r += t[n].length;
      const i = o.allocUnsafe(r);
      let u = 0;
      for (n = 0; n < t.length; ++n) {
        let s = t[n];
        if (z(s, Uint8Array))
          u + s.length > i.length ? (o.isBuffer(s) || (s = o.from(s)), s.copy(i, u)) : Uint8Array.prototype.set.call(
            i,
            s,
            u
          );
    ...
    o.prototype.swap16 = function() {
      ...
      const t = this.length;
      return t === 0 ? "" : arguments.length === 0 ? L(this, 0, t) : q.apply(this, arguments);
      ...
      let t = "";
      const r = a.INSPECT_MAX_BYTES;
      return t = this.toString("hex", 0, r).replace(/(.{2})/g, "$1 ").trim(), this.length > r && (t += " ... "), "<Buffer " + t + ">";
    }, p && (o.prototype[p] = o.prototype.inspect), o.prototype.compare = function(t, r, n, i, u) {
      if (z(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), !o.isBuffer(t))
        throw new TypeError(
          'The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof t
        );
      if (r === void 0 && (r = 0), n === void 0 && (n = t ? t.length : 0), i === void 0 && (i = 0), u === void 0 && (u = this.length), r < 0 || n > t.length || i < 0 || u > this.length)
      ...
      if (r >= n)
        return 1;
      if (r >>>= 0, n >>>= 0, i >>>= 0, u >>>= 0, this === t) return 0;
      let s = u - i, x = n - r;
      const k = Math.min(s, x), R = this.slice(i, u), _ = t.slice(r, n);
      for (let E = 0; E < k; ++E)
        if (R[E] !== _[E]) {
          s = R[E], x = _[E];
          break;
        }
      return s < x ? -1 : x < s ? 1 : 0;
    };
    function H(e, t, r, n, i) {
      if (e.length === 0) return -1;
      if (typeof r == "string" ? (n = r, r = 0) : r > 2147483647 ? r = 2147483647 : r < -2147483648 && (r = -2147483648), r = +r, st(r) && (r = i ? 0 : e.length - 1), r < 0 && (r = e.length + r), r >= e.length) {
        if (i) return -1;
        r = e.length - 1;
      } else if (r < 0)
        if (i) r = 0;
      ...
      if (typeof t == "string" && (t = o.from(t, n)), o.isBuffer(t))
        return t.length === 0 ? -1 : j(e, t, r, n, i);
      if (typeof t == "number")
        return t = t & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : j(e, [t], r, n, i);
      throw new TypeError("val must be string, number or Buffer");
    }
    function j(e, t, r, n, i) {
      let u = 1, s = e.length, x = t.length;
      ...
      function k(_, E) {
        return u === 1 ? _[E] : _.readUInt16BE(E * u);
      }
      let R;
      if (i) {
        let _ = -1;
        for (R = r; R < s; R++)
          if (k(e, R) === k(t, _ === -1 ? 0 : R - _)) {
            if (_ === -1 && (_ = R), R - _ + 1 === x) return _ * u;
          } else
            _ !== -1 && (R -= R - _), _ = -1;
      } else
        for (r + x > s && (r = s - x), R = r; R >= 0; R--) {
          let _ = !0;
          for (let E = 0; E < x; E++)
            if (k(e, R + E) !== k(t, E)) {
              _ = !1;
    ...
    function J(e, t, r, n) {
      ...
      let s;
      for (s = 0; s < n; ++s) {
        const x = parseInt(t.substr(s * 2, 2), 16);
        if (st(x)) return s;
        e[r + s] = x;
      }
      return s;
    ...
    function X(e, t, r, n) {
      return Q(ut(t, e.length - r), e, r, n);
    }
    function nt(e, t, r, n) {
      return Q(Tt(t), e, r, n);
    }
    ...
    function D(e, t, r, n) {
      return Q(Nt(t, e.length - r), e, r, n);
    }
    o.prototype.write = function(t, r, n, i) {
      if (r === void 0)
    ...
    function $(e, t, r) {
      return t === 0 && r === e.length ? c.fromByteArray(e) : c.fromByteArray(e.slice(t, r));
    }
    function L(e, t, r) {
      ...
      for (; i < r; ) {
        const u = e[i];
        let s = null, x = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
        if (i + x <= r) {
          let k, R, _, E;
          switch (x) {
            case 1:
              ...
              break;
            case 2:
              k = e[i + 1], (k & 192) === 128 && (E = (u & 31) << 6 | k & 63, E > 127 && (s = E));
              break;
            case 3:
              k = e[i + 1], R = e[i + 2], (k & 192) === 128 && (R & 192) === 128 && (E = (u & 15) << 12 | (k & 63) << 6 | R & 63, E > 2047 && (E < 55296 || E > 57343) && (s = E));
              break;
            case 4:
              k = e[i + 1], R = e[i + 2], _ = e[i + 3], (k & 192) === 128 && (R & 192) === 128 && (_ & 192) === 128 && (E = (u & 15) << 18 | (k & 63) << 12 | (R & 63) << 6 | _ & 63, E > 65535 && E < 1114112 && (s = E));
          }
        }
        s === null ? (s = 65533, x = 1) : s > 65535 && (s -= 65536, n.push(s >>> 10 & 1023 | 55296), s = 56320 | s & 1023), n.push(s), i += x;
      }
      return b(n);
    }
    const w = 4096;
    ...
    o.prototype.readUintLE = o.prototype.readUIntLE = function(t, r, n) {
      t = t >>> 0, r = r >>> 0, n || N(t, r, this.length);
      let i = this[t], u = 1, s = 0;
      for (; ++s < r && (u *= 256); )
        i += this[t + s] * u;
      return i;
      ...
      (r === void 0 || n === void 0) && K(t, this.length - 8);
      const i = r + this[++t] * 2 ** 8 + this[++t] * 2 ** 16 + this[++t] * 2 ** 24, u = this[++t] + this[++t] * 2 ** 8 + this[++t] * 2 ** 16 + n * 2 ** 24;
      return BigInt(i) + (BigInt(u) << BigInt(32));
    }), o.prototype.readBigUInt64BE = W(function(t) {
      t = t >>> 0, G(t, "offset");
      const r = this[t], n = this[t + 7];
      (r === void 0 || n === void 0) && K(t, this.length - 8);
      const i = r * 2 ** 24 + this[++t] * 2 ** 16 + this[++t] * 2 ** 8 + this[++t], u = this[++t] * 2 ** 24 + this[++t] * 2 ** 16 + this[++t] * 2 ** 8 + n;
      ...
      for (; ++s < r && (u *= 256); )
        i += this[t + s] * u;
      return u *= 128, i >= u && (i -= Math.pow(2, 8 * r)), i;
    }, o.prototype.readIntBE = function(t, r, n) {
      t = t >>> 0, r = r >>> 0, n || N(t, r, this.length);
      let i = r, u = 1, s = this[t + --i];
      for (; i > 0 && (u *= 256); )
        s += this[t + --i] * u;
      return u *= 128, s >= u && (s -= Math.pow(2, 8 * r)), s;
      ...
      return t = t >>> 0, r || N(t, 4, this.length), l.read(this, t, !0, 23, 4);
    }, o.prototype.readFloatBE = function(t, r) {
      return t = t >>> 0, r || N(t, 4, this.length), l.read(this, t, !1, 23, 4);
    }, o.prototype.readDoubleLE = function(t, r) {
      return t = t >>> 0, r || N(t, 8, this.length), l.read(this, t, !0, 52, 8);
    }, o.prototype.readDoubleBE = function(t, r) {
      return t = t >>> 0, r || N(t, 8, this.length), l.read(this, t, !1, 52, 8);
    };
    ...
    o.prototype.writeUintLE = o.prototype.writeUIntLE = function(t, r, n, i) {
      if (t = +t, r = r >>> 0, n = n >>> 0, !i) {
        const x = Math.pow(2, 8 * n) - 1;
        M(this, t, r, n, x, 0);
      }
      let u = 1, s = 0;
      for (this[r] = t & 255; ++s < n && (u *= 256); )
        this[r + s] = t / u & 255;
      return r + n;
    }, o.prototype.writeUintBE = o.prototype.writeUIntBE = function(t, r, n, i) {
      if (t = +t, r = r >>> 0, n = n >>> 0, !i) {
        const x = Math.pow(2, 8 * n) - 1;
        M(this, t, r, n, x, 0);
      }
      let u = n - 1, s = 1;
      for (this[r + u] = t & 255; --u >= 0 && (s *= 256); )
        this[r + u] = t / s & 255;
      return r + n;
    ...
    function lt(e, t, r, n, i) {
      ...
      e[r++] = u, u = u >> 8, e[r++] = u, u = u >> 8, e[r++] = u, u = u >> 8, e[r++] = u;
    ...
    function ht(e, t, r, n, i) {
      mt(t, n, i, e, r, 7);
      let u = Number(t & BigInt(4294967295));
      e[r + 7] = u, u = u >> 8, e[r + 6] = u, u = u >> 8, e[r + 5] = u, u = u >> 8, e[r + 4] = u;
      let s = Number(t >> BigInt(32) & BigInt(4294967295));
      return e[r + 3] = s, s = s >> 8, e[r + 2] = s, s = s >> 8, e[r + 1] = s, s = s >> 8, e[r] = s, r + 8;
    }
    o.prototype.writeBigUInt64LE = W(function(t, r = 0) {
      return lt(this, t, r, BigInt(0), BigInt("0xffffffffffffffff"));
    }), o.prototype.writeBigUInt64BE = W(function(t, r = 0) {
      return ht(this, t, r, BigInt(0), BigInt("0xffffffffffffffff"));
    }), o.prototype.writeIntLE = function(t, r, n, i) {
      if (t = +t, r = r >>> 0, !i) {
        const k = Math.pow(2, 8 * n - 1);
        M(this, t, r, n, k - 1, -k);
      }
      let u = 0, s = 1, x = 0;
      for (this[r] = t & 255; ++u < n && (s *= 256); )
        t < 0 && x === 0 && this[r + u - 1] !== 0 && (x = 1), this[r + u] = (t / s >> 0) - x & 255;
      return r + n;
    }, o.prototype.writeIntBE = function(t, r, n, i) {
      if (t = +t, r = r >>> 0, !i) {
        const k = Math.pow(2, 8 * n - 1);
        M(this, t, r, n, k - 1, -k);
      }
    ...
    }, o.prototype.writeBigInt64LE = W(function(t, r = 0) {
      return lt(this, t, r, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    }), o.prototype.writeBigInt64BE = W(function(t, r = 0) {
      return ht(this, t, r, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    });
    function pt(e, t, r, n, i, u) {
      if (r + n > e.length) throw new RangeError("Index out of range");
      if (r < 0) throw new RangeError("Index out of range");
    }
    function dt(e, t, r, n, i) {
      return t = +t, r = r >>> 0, i || pt(e, t, r, 4), l.write(e, t, r, n, 23, 4), r + 4;
    }
    ...
    function yt(e, t, r, n, i) {
      return t = +t, r = r >>> 0, i || pt(e, t, r, 8), l.write(e, t, r, n, 52, 8), r + 8;
    }
    o.prototype.writeDoubleLE = function(t, r, n) {
    ...
    }, o.prototype.copy = function(t, r, n, i) {
    ...
    }, o.prototype.fill = function(t, r, n, i) {
      if (typeof t == "string") {
      ...
      if (typeof t == "number")
        ...
        const s = o.isBuffer(t) ? t : o.from(t, i), x = s.length;
        if (x === 0)
    ...
    function _t(e, t, r) {
      G(t, "offset"), (e[t] === void 0 || e[t + r] === void 0) && K(t, e.length - (r + 1));
    }
    function mt(e, t, r, n, i, u) {
      if (e > r || e < t) {
        const s = typeof t == "bigint" ? "n" : "";
        let x;
        throw t === 0 || t === BigInt(0) ? x = `>= 0${s} and < 2${s} ** ${(u + 1) * 8}${s}` : x = `>= -(2${s} ** ${(u + 1) * 8 - 1}${s}) and < 2 ** ${(u + 1) * 8 - 1}${s}`, new V.ERR_OUT_OF_RANGE("value", x, e);
      }
      _t(n, i, u);
    }
    function G(e, t) {
    ...
    function K(e, t, r) {
      throw Math.floor(e) !== e ? (G(e, r), new V.ERR_OUT_OF_RANGE("offset", "an integer", e)) : t < 0 ? new V.ERR_BUFFER_OUT_OF_BOUNDS() : new V.ERR_OUT_OF_RANGE(
        "offset",
        `>= 0 and <= ${t}`,
        e
      );
    ...
    function Lt(e) {
      if (e = e.split("=")[0], e = e.trim().replace(Pt, ""), e.length < 2) return "";
      for (; e.length % 4 !== 0; )
        e = e + "=";
      return e;
    }
    ...
    function Nt(e, t) {
      ...
      for (let s = 0; s < e.length && !((t -= 2) < 0); ++s)
        r = e.charCodeAt(s), n = r >> 8, i = r % 256, u.push(i), u.push(n);
      return u;
    }
    function wt(e) {
      return c.toByteArray(Lt(e));
    }
    function Q(e, t, r, n) {
      let i;
...
var At;
function Wt() {
  return At || (At = 1, (function(a, c) {
    var l = $t(), p = l.Buffer;
    function g(f, o) {
      for (var B in f)
        o[B] = f[B];
    }
    p.from && p.alloc && p.allocUnsafe && p.allocUnsafeSlow ? a.exports = l : (g(l, c), c.Buffer = d);
    function d(f, o, B) {
      return p(f, o, B);
    }
    d.prototype = Object.create(p.prototype), g(p, d), d.from = function(f, o, B) {
      if (typeof f == "number")
        throw new TypeError("Argument must not be a number");
      return p(f, o, B);
    }, d.alloc = function(f, o, B) {
      if (typeof f != "number")
        throw new TypeError("Argument must be a number");
      var I = p(f);
      return o !== void 0 ? typeof B == "string" ? I.fill(o, B) : I.fill(o) : I.fill(0), I;
      ...
      if (typeof f != "number")
        throw new TypeError("Argument must be a number");
      return l.SlowBuffer(f);
    };
  })(rt, rt.exports)), rt.exports;
}
var Ft;
function vt() {
  if (Ft) return tt.exports;
  Ft = 1;
  var a = 65536, c = 4294967295;
  function l() {
    throw new Error(`Secure random number generation is not supported by this browser.
Use Chrome, Firefox or Internet Explorer 11`);
  }
  var p = Wt().Buffer, g = xt.crypto || xt.msCrypto;
  g && g.getRandomValues ? tt.exports = d : tt.exports = l;
  function d(f, o) {
    if (f > c) throw new RangeError("requested too many random bytes");
    var B = p.allocUnsafe(f);
    if (f > 0)
      if (f > a)
        for (var I = 0; I < f; I += a)
          g.getRandomValues(B.slice(I, I + a));
      else
        g.getRandomValues(B);
...
function jt() {
  if (St) return ct;
  St = 1;
  var a = vt(), c = 16, l = F(), p = new RegExp('(\\\\)?"@__(F|R|D|M|S|A|U|I|B|L)-' + l + '-(\\d+)__@"', "g"), g = /\{\s*\[native code\]\s*\}/g, d = /function.*?\(/, f = /.*?=>.*?/, o = /[<>\/\u2028\u2029]/g, B = ["*", "async"], I = {
    "<": "\\u003C",
    ">": "\\u003E",
    "/": "\\u002F",
    "\u2028": "\\u2028",
  ...
  function O(h) {
    var m = [];
    for (var y in h)
      typeof h[y] == "function" && m.push(y);
    for (var S = 0; S < m.length; S++)
      delete h[m[S]];
  }
  return ct = function h(m, y) {
    y || (y = {}), (typeof y == "number" || typeof y == "string") && (y = { space: y });
    var S = [], P = [], U = [], T = [], q = [], C = [], H = [], j = [], J = [], X = [];
    function nt($, L) {
      if (y.ignoreFunction && O(L), !L && L !== void 0 && L !== BigInt(0))
        return L;
      var w = this[$], b = typeof w;
      if (b === "object") {
        if (w instanceof RegExp)
          return "@__R-" + l + "-" + (P.push(w) - 1) + "__@";
        if (w instanceof Date)
          return "@__D-" + l + "-" + (U.push(w) - 1) + "__@";
        if (w instanceof Map)
          return "@__M-" + l + "-" + (T.push(w) - 1) + "__@";
        if (w instanceof Set)
          return "@__S-" + l + "-" + (q.push(w) - 1) + "__@";
        if (w instanceof Array) {
          var v = w.filter(function() {
            return !0;
          }).length !== w.length;
          if (v)
            return "@__A-" + l + "-" + (C.push(w) - 1) + "__@";
        }
        if (w instanceof URL)
          return "@__L-" + l + "-" + (X.push(w) - 1) + "__@";
      }
      return b === "function" ? "@__F-" + l + "-" + (S.push(w) - 1) + "__@" : b === "undefined" ? "@__U-" + l + "-" + (H.push(w) - 1) + "__@" : b === "number" && !isNaN(w) && !isFinite(w) ? "@__I-" + l + "-" + (j.push(w) - 1) + "__@" : b === "bigint" ? "@__B-" + l + "-" + (J.push(w) - 1) + "__@" : L;
    }
    function it($) {
      var L = $.toString();
      if (g.test(L))
        throw new TypeError("Serializing native function: " + $.name);
      if (d.test(L) || f.test(L))
        return L;
      var w = L.indexOf("("), b = L.substr(0, w).trim().split(" ").filter(function(Y) {
        return Y.length > 0;
      }), v = b.filter(function(Y) {
        return B.indexOf(Y) === -1;
      });
      return v.length > 0 ? (b.indexOf("async") > -1 ? "async " : "") + "function" + (b.join("").indexOf("*") > -1 ? "*" : "") + L.substr(w) : L;
    }
    if (y.ignoreFunction && typeof m == "function" && (m = void 0), m === void 0)
      return String(m);
    var D;
    return y.isJSON && !y.space ? D = JSON.stringify(m) : D = JSON.stringify(m, y.isJSON ? null : nt, y.space), typeof D != "string" ? String(D) : (y.unsafe !== !0 && (D = D.replace(o, A)), S.length === 0 && P.length === 0 && U.length === 0 && T.length === 0 && q.length === 0 && C.length === 0 && H.length === 0 && j.length === 0 && J.length === 0 && X.length === 0 ? D : D.replace(p, function($, L, w, b) {
      if (L)
        return $;
      if (w === "D")
        return 'new Date("' + U[b].toISOString() + '")';
      if (w === "R")
        return "new RegExp(" + h(P[b].source) + ', "' + P[b].flags + '")';
      if (w === "M")
        return "new Map(" + h(Array.from(T[b].entries()), y) + ")";
      if (w === "S")
        return "new Set(" + h(Array.from(q[b].values()), y) + ")";
      if (w === "A")
        return "Array.prototype.slice.call(" + h(Object.assign({ length: C[b].length }, C[b]), y) + ")";
      if (w === "U")
        return "undefined";
      if (w === "I")
        return j[b];
      if (w === "B")
        return 'BigInt("' + J[b] + '")';
      if (w === "L")
        return "new URL(" + h(X[b].toString(), y) + ")";
      var v = S[b];
      return it(v);
    }));
  }, ct;
...
var Vt = jt();
const Ct = /* @__PURE__ */ qt(Vt), Ut = "sanity:client", Rt = "\0" + Ut;
function Gt(a, c = {}) {
  const l = c.logClientRequests;
  return {
    name: "sanity:client",
    resolveId(p) {
      if (p === Ut)
...
function ft(a) {
  const c = a == null ? void 0 : a.replace(/^\/+|\/+$/g, "");
  return c ? `/${c}` : void 0;
}
function Ht(a, c) {
  const l = ft(a);
  if (l)
    return c === "hash" ? l : `${l}/[...params]`;
}
function Jt(a) {
  const c = "sanity:studio", l = c;
  return {
    name: "sanity:studio",
    resolveId(p) {
      return p === c ? l : null;
    ...
    async load(p) {
      if (p === c) {
        const g = await this.resolve("/sanity.config");
        if (!g)
          throw new Error(
        ...
        const d = ft(a.studioBasePath);
        if (!d)
          throw new Error(
            "[@sanity/astro]: The `studioBasePath` option cannot be empty. For example — `studioBasePath: '/admin'`"
          );
        const f = a.studioRouterHistory === "hash" ? "hash" : "browser";
        return `
        import studioConfig from "${g.id}";

        const embeddedStudioBasePath = "${d}";
        const historyMode = "${f}";
...
function Xt() {
  const a = "sanity:studio-hash-router", c = a;
  return {
    ...
    async load(l) {
      if (l === a) {
        const p = await this.resolve("/sanity.config");
        if (!p)
          throw new Error(
            "[@sanity/astro]: Sanity Studio requires a `sanity.config.ts|js` file in your project root."
          );
        return `export {default} from "${p.id}";`;
      }
      return null;
    }
  };
...
function Zt(a) {
  ...
  return Kt.some((l) => c.includes(l));
}
function Qt(a) {
  const l = [a.name, a.fileName, a.facadeModuleId, ...a.moduleIds ?? []].filter((p) => typeof p == "string").join(" ");
  return Zt(l);
}
function tr(a) {
  const c = /* @__PURE__ */ new Set(), l = [];
  for (const p of a.values())
    Qt(p) && l.push(p.fileName);
  for (; l.length > 0; ) {
    const p = l.pop();
    if (!p || c.has(p))
      continue;
    ...
    const g = a.get(p);
    if (g)
      for (const d of [...g.imports ?? [], ...g.dynamicImports ?? []])
        a.has(d) && !c.has(d) && l.push(d);
  }
  return c;
}
function rr(a, c) {
  const l = c.map((p) => `- ${p}`).join(`
`);
  return `Some chunks are larger than ${a} kB after minification. Consider:
${l}
...
function er(a, c) {
  ...
  for (const g of a.values()) {
    if (l.has(g.fileName))
      continue;
    const d = g.code ?? "";
    Buffer.byteLength(d, "utf8") / 1024 > c && p.push(g.fileName);
  }
  return p;
}
function nr() {
  ...
  return {
    ...
    config(c) {
      var l;
      return typeof ((l = c.build) == null ? void 0 : l.chunkSizeWarningLimit) == "number" && (a = c.build.chunkSizeWarningLimit), {
        build: {
    ...
    generateBundle(c, l) {
      ...
      for (const d of Object.values(l))
        d.type === "chunk" && p.set(d.fileName, {
          name: d.name,
          fileName: d.fileName,
          facadeModuleId: d.facadeModuleId,
          moduleIds: Object.keys(d.modules),
          imports: d.imports,
...
function or(a, c) {
  return a === "hash" || a === "browser" ? a : c === "static" ? "hash" : "browser";
}
function sr(a = {}) {
  const c = a.studioBasePath, l = ft(c), p = a.studioRouterHistory, g = a.logClientRequests, d = a;
  if (delete d.studioBasePath, delete d.studioRouterHistory, delete d.logClientRequests, c && c.match(/https?:\/\//))
    throw new Error(
  ...
  return {
    name: "@sanity/astro",
    hooks: {
      "astro:config:setup": ({ config: f, injectScript: o, injectRoute: B, updateConfig: I }) => {
        const A = or(
          p,
          f == null ? void 0 : f.output
        );
        I({
          vite: {
            optimizeDeps: {
